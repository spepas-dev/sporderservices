...
exports.REQUEST_BIDDINGS = asynHandler(async (req, res, next) => {
  ...
  var loginUrl = process.env.DB_BASE_URL +"bidding/request-biddings/"+request_id; 
...
exports.SELLER_ACTIVE_BIDDINGS = asynHandler(async (req, res, next) => {
  ...
  var loginUrl = process.env.DB_BASE_URL +"bidding/seller-active-biddings/"+seller_id; 
...
exports.SELLER_BIDDINGS_HISTORY = asynHandler(async (req, res, next) => {
  ...
  var loginUrl = process.env.DB_BASE_URL +"bidding/seller-bidding-history/"+seller_id; 
...
exports.GOPA_ACTIVE_ASSIGN_BIDDINGS = asynHandler(async (req, res, next) => {
  ...
  var loginUrl = process.env.DB_BASE_URL +"bidding/gopa-active-assign-bidding/"+user_id; 
...
exports.GOPA_ASSIGN_BIDDING_HISTORY = asynHandler(async (req, res, next) => {
  ...
  var loginUrl = process.env.DB_BASE_URL +"bidding/gopa-assign-bidding-history/"+user_id; 
...
exports.GOPA_ACTIVE_BIDDINGS = asynHandler(async (req, res, next) => {
  ...
  var loginUrl = process.env.DB_BASE_URL +"bidding/gopa-active-biddings/"+user_id; 
...
exports.GOPA_BIDDING_HISTORY = asynHandler(async (req, res, next) => {
  ...
  var loginUrl = process.env.DB_BASE_URL +"bidding/gopa-biddings-history/"+user_id; 
...
exports.ACCEPT_BID = asynHandler(async (req, res, next) => {
  ...
  let biddingResponse = await UtilityHelper.makeHttpRequest("POST",biddingUrl, bidDetails);
  ...
  var ReqDetailsURL = process.env.DB_BASE_URL +"order-request/full-details/"+bidDetails.request_ID; 
    ...
    //TODO Validate file to only accept PDF
     ...
     try {
        const result = await cloudinary.uploader.upload(req.file.path, {
            folder: 'BiddingImages', // Optional: Organize files in a folder
          });
