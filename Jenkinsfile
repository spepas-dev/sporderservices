namespace = "default"
serviceName = "spepas-order"
service = "Spepas Order"
...
pipeline {
  ...
  environment {
    ...
    IMAGE_NAME = "jboadi" + "/" + "spepas-order"
  ...
  stages {
    ...
    stage("Prepare Environment") {
      steps {
        ...
        git branch: 'main', credentialsId: 'github', url: 'https://github.com/spepas-dev/sporderservices'
        sh 'npm install'
      }
    }
